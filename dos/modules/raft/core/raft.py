...
class RAFT(nn.Module):
    def __init__(self, small=False, dropout=0, alternate_corr=False, mixed_precision=False):
        ...
        if small:
            ...
            self.update_block = SmallUpdateBlock({"corr_levels": self.corr_levels, "corr_radius": self.corr_radius}, hidden_dim=hdim)
            ...
            self.update_block = BasicUpdateBlock({"corr_levels": self.corr_levels, "corr_radius": self.corr_radius}, hidden_dim=hdim)
